...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Template.template_title'
        db.alter_column(u'template_template', 'template_title', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=50))
        # Adding index on 'Template', fields ['template_title']
        db.create_index(u'template_template', ['template_title'])


    def backwards(self, orm):
        # Removing index on 'Template', fields ['template_title']
        db.delete_index(u'template_template', ['template_title'])


        # Changing field 'Template.template_title'
        db.alter_column(u'template_template', 'template_title', self.gf('django.db.models.fields.CharField')(max_length=256, unique=True))
