...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Template', fields ['template_title']
        db.create_unique(u'template_template', ['template_title'])


    def backwards(self, orm):
        # Removing unique constraint on 'Template', fields ['template_title']
        db.delete_unique(u'template_template', ['template_title'])
