...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TemplateRevision.template_title'
        db.delete_column(u'template_templaterevision', 'template_title')


    def backwards(self, orm):
        # Adding field 'TemplateRevision.template_title'
        db.add_column(u'template_templaterevision', 'template_title',
    ...
    models = {
        ...
        'template.template': {
            ...
            'template_title': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '256'})
        },
