...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'notifications.articlesubscription': {
            'Meta': {'unique_together': "((u'subscription', u'articleplugin_ptr'),)", 'object_name': 'ArticleSubscription', 'db_table': "u'wiki_notifications_articlesubscription'", '_ormbases': ['wiki.ArticlePlugin']},
