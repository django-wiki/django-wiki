...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'images.image': {
            'Meta': {'object_name': 'Image', 'db_table': "u'wiki_images_image'", '_ormbases': ['wiki.RevisionPlugin']},
        ...
        'images.imagerevision': {
            'Meta': {'ordering': "(u'-created',)", 'object_name': 'ImageRevision', 'db_table': "u'wiki_images_image'", '_ormbases': ['wiki.RevisionPluginRevision']},
