...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('attachments_attachmentrevision', 'previous_revision_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['attachments.AttachmentRevision'], null=True, on_delete=models.SET_NULL))

        # Changing field 'AttachmentRevision.user'
        db.alter_column('attachments_attachmentrevision', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm[user_orm_label], null=True, on_delete=models.SET_NULL))

        # Changing field 'AttachmentRevision.file'
        db.alter_column('attachments_attachmentrevision', 'file', self.gf('django.db.models.fields.files.FileField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'AttachmentRevision.previous_revision'
        db.alter_column('attachments_attachmentrevision', 'previous_revision_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['attachments.AttachmentRevision'], null=True))

        # Changing field 'AttachmentRevision.user'
        db.alter_column('attachments_attachmentrevision', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm[user_orm_label], null=True))

        # Changing field 'AttachmentRevision.file'
        db.alter_column('attachments_attachmentrevision', 'file', self.gf('django.db.models.fields.files.FileField')(max_length=100))
